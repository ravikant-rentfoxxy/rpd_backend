-- RPD full schema: tables + foreign keys
-- Open on a website (import as PostgreSQL SQL):
--   https://dbdiagram.io     → Import → PostgreSQL
--   https://azimutt.app      → New → Import SQL
--   https://app.chartdb.io   → Import → SQL
-- Do not run this against the live DB; it is for viewing only.
...
-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('MEMBER', 'PANNA_PRAMUKH', 'BOOTH_ADHYAKSH', 'NATIONAL_PRESIDENT', 'NATIONAL_GENERAL_SECRETARY', 'STATE_PRESIDENT', 'STATE_GENERAL_SECRETARY', 'REGIONAL_PRESIDENT', 'DISTRICT_PRESIDENT', 'DISTRICT_GENERAL_SECRETARY', 'DISTRICT_SECRETARY', 'ASSEMBLY_IN_CHARGE', 'MANDAL_PRESIDENT');
...
-- CreateIndex
CREATE UNIQUE INDEX "consent_documents_version_kind_locale_key" ON "consent_documents"("version", "kind", "locale");
...
-- AddForeignKey
ALTER TABLE "org_posts" ADD CONSTRAINT "org_posts_level_id_fkey" FOREIGN KEY ("level_id") REFERENCES "org_levels"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "assembly_constituencies" ADD CONSTRAINT "assembly_constituencies_state_id_fkey" FOREIGN KEY ("state_id") REFERENCES "states"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "members" ADD CONSTRAINT "members_state_id_fkey" FOREIGN KEY ("state_id") REFERENCES "states"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "members" ADD CONSTRAINT "members_region_id_fkey" FOREIGN KEY ("region_id") REFERENCES "regions"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "member_posts" ADD CONSTRAINT "member_posts_assembly_id_fkey" FOREIGN KEY ("assembly_id") REFERENCES "assembly_constituencies"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "member_posts" ADD CONSTRAINT "member_posts_region_id_fkey" FOREIGN KEY ("region_id") REFERENCES "regions"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "member_posts" ADD CONSTRAINT "member_posts_state_id_fkey" FOREIGN KEY ("state_id") REFERENCES "states"("id") ON DELETE SET NULL ON UPDATE CASCADE;
